...
namespace CheckersLogic
{
    public class Player
    {
        ...
        public void InitializePlayer(int i_PlayerType, int i_PlayerNumber, Board i_GameBoard)
        {
            ...
            m_LastMovement = null;
            if (i_PlayerNumber == (int)ePlayerNumber.PlayerOne)
            {
                m_ToolShape = (char)GameTool.eSigns.PlayerO;
            }
            else
            {
                m_ToolShape = (char)GameTool.eSigns.PlayerX;
            }
        ...
        {
            int playerNumber;
            if (m_ToolShape == (char)GameTool.eSigns.PlayerO)
            {
                playerNumber = (int)ePlayerNumber.PlayerOne;
            }
            else
            {
                playerNumber = (int)ePlayerNumber.PlayerTwo;
            }
            m_PlayerTools.Clear();
