...
namespace CheckersLogic
{
    public class GameTool
    {
        ...
        public GameTool(Point point, char m_ToolShape)
        {
            m_Location = point;
            m_Sign = m_ToolShape;
            if (m_Sign == (char)eSigns.PlayerO)
            {
                m_FriendSign = (char)eSigns.PlayerOKing;
            }
            else
            {
                m_FriendSign = (char)eSigns.PlayerXKing;
            }
        }
        public char Sign
        {
        ...
        public int Value
        {
            get
            {
                if (IsKing())
                {
                    return (int)eValue.King;
                }
                else
                {
                    return (int)eValue.Regular;
                }
            }
        }
        ...
        {
            if (m_Sign == (char)eSigns.PlayerO || m_Sign == (char)eSigns.PlayerOKing)
            {
